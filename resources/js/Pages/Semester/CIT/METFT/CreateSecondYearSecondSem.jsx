...
const CreateSecondYearSecondSem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateSecondYearSecondSem", // Component identifier
      source: "METFTStem", // Source parameter
    };
...
export default CreateSecondYearSecondSem;
