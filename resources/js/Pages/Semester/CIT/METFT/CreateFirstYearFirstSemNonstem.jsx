...
const CreateFirstYearFirstSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateFirstYearFirstSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("firstyearfirstsem.store", requestData));
  };
...
export default CreateFirstYearFirstSemNonstem;
