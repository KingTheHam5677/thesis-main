...
const CreateFourthYearSecondSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateFourthYearSecondSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("fourthyearsecondsem.store", requestData));
  };
...
export default CreateFourthYearSecondSemNonstem;
