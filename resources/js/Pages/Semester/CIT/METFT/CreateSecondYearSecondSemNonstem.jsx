...
const CreateSecondYearSecondSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateSecondYearSecondSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("secondyearsecondsem.store", requestData));
  };
...
export default CreateSecondYearSecondSemNonstem;
