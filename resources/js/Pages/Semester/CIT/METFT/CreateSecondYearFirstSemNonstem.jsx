...
const CreateSecondYearFirstSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateSecondYearFirstSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("secondyearfirstsem.store", requestData));
  };
...
export default CreateSecondYearFirstSemNonstem;
