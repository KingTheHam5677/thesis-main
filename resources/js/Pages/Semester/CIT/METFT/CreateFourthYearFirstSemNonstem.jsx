...
const CreateFourthYearFirstSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateFourthYearFirstSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("fourthyearfirstsem.store", requestData));
  };
...
export default CreateFourthYearFirstSemNonstem;
