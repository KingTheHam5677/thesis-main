...
const CreateFirstYearSecondSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateFirstYearSecondSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("firstyearsecondsem.store", requestData));
  };
...
export default CreateFirstYearSecondSemNonstem;
