...
const CreateThirdYearSecondSemNonstem = ({ auth }) => {
  ...
  const onSubmit = (e) => {
    ...
    const requestData = {
      ...
      component: "CreateThirdYearSecondSemNonstem", // Component identifier
      source: "METFTNonstem", // Source parameter
    };

    post(route("thirdyearsecondsem.store", requestData));
  };
...
export default CreateThirdYearSecondSemNonstem;
